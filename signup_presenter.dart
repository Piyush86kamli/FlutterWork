...
class SignupPresenter {
  ...
  doSignup(BuildContext getContext,String username,String email, String date_of_birth,String password) async {
    try {
      await api.signup(getContext,username, email,date_of_birth, password).then((SignupPojo user) {
